...
def get_code_of_conduct() -> str:
    ...
    print(f"Fetching code of conduct from: {pdf_full_path}")
...
#-----------------------------------------------------------------------
# Add Operation: list_operations
#-----------------------------------------------------------------------
@hr_coc_mcp.tool(
    name="list_operations",
    title="List MCP Operations",
    description="Returns a list of all available MCP operations."
)
def list_operations() -> list[str]:
    """Return the names of all registered operations."""
    return [op.name for op in hr_coc_mcp.tools]
